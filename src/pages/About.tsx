...
import { ArrowRight, Heart, Coffee, Code, Globe, Users, Award } from "lucide-react";
  ...
  const values = [
    {
      ...
      description: "Vi brænder for at skabe smukke og funktionelle digitale oplevelser"
    },
    {
      icon: Coffee,
      title: "Nordisk arbejdskultur",
      description: "Vi tror på balance, kvalitet og ærlighed i alt hvad vi laver"
    },
    {
      icon: Code,
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              To danske webnørder med passion for design, teknologi og brugervenlighed. 
              Vi hjælper iværksættere og små virksomheder med at komme trygt og professionelt online.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-muted-foreground">
                <p>
                  Nordweb blev skabt ud fra en simpel observation: For mange små virksomheder 
                  kæmper med at komme professionelt online uden at skulle betale formuer til 
                  store bureauer eller kæmpe med komplicerede systemer.
                </p>
                <p>
                  Vi troede på, at det kunne gøres bedre. Simplere. Mere gennemsigtigt. 
                  Med nordisk kvalitet og uden skjulte omkostninger.
                </p>
                <p>
                  I dag hjælper vi virksomheder i hele Norden med at få en stærk digital tilstedeværelse 
                  gennem vores abonnementsmodel, der gør det muligt for alle at have en professionel hjemmeside.
                </p>
              </div>
            </div>
            <div className="nordic-card rounded-3xl p-8 bg-gradient-to-br from-primary/5 to-nordic-gold/5">
              <blockquote className="text-xl italic text-fjord mb-6">
                ...
                Hver kunde fortjener den bedste service - uanset størrelse."
              </blockquote>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Disse principper styrer alt hvad vi laver - fra den første skitse til den løbende support.
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="nordic-hover-card nordic-card rounded-2xl p-6 text-center group">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              At gøre professionel webudvikling tilgængelig for alle virksomheder i Norden. 
              Vi tror på, at enhver virksomhed fortjener en stærk digital tilstedeværelse - 
              uden at skulle bruge en formue eller blive ekspert i teknologi.
            </p>
            <Button 
              size="lg" 
