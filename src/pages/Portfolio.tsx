  ...
  const projects = [
    {
      ...
      description:
        "Moderne hjemmeside for cateringvirksomhed med online bestilling og menukort",
    ...
    },
    {
      title: "Grøn Arkitekt",
      description:
        "Portfolio-site for bæredygtig arkitektfirma med fokus på miljøvenlige løsninger",
      category: "Arkitektur",
      technologies: ["Portfolio", "Mobil-venlig", "Analytics"],
      image:
        "https://images.unsplash.com/photo-1487958449943-2429e8be8625?auto=format&fit=crop&w=800&q=80",
      features: [
        "Interaktivt portfolio",
        "Projekt galleries",
        "Kontakt integration",
      ],
    ...
    },
    {
      title: "FitLife Gym",
      description:
        "Dynamisk fitness-site med medlemsskab, holdplan og online træning",
    ...
    },
    {
      ...
      description:
        "Kreativ portfolio for designstudio med fokus på brugeroplevelse og conversion",
    ...
    },
    {
      ...
      description:
        "Professionel B2B-site for konsulentvirksomhed med lead generation fokus",
    ...
    },
    {
      ...
      description:
        "Holistisk wellness-center med booking system og e-commerce integration",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Se hvordan vi har hjulpet virksomheder i hele norden med at skabe
              stærke digitale tilstedeværelser og opnå målbare resultater
              online.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {projects.map((project, index) => (
              <Card
                key={index}
                className="nordic-hover-card nordic-card rounded-3xl overflow-hidden group"
              >
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      <h4 className="font-semibold text-fjord mb-2">
                        Teknologier
                      </h4>
      ...
      <section className="py-24 bg-gradient-to-b from-background via-secondary/20 to-background">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-fjord mb-6">Vores proces</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Vi følger en struktureret proces for at sikre det bedste resultat
              for dit projekt.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Vi analyserer dine behov, målgruppe og konkurrenter for at skabe
                den bedste strategi.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Vi designer og udvikler din hjemmeside med fokus på
                brugervenlighed og performance.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Vi lancerer din site og sørger for løbende support,
        ...
        <div className="container mx-auto px-6">
          <div className="text-center nordic-card rounded-3xl p-12 bg-gradient-to-br from-primary/5 via-card to-nordic-gold/5 border border-primary/10 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Lad os skabe noget fantastisk sammen. Kontakt os i dag for en
              gratis konsultation om dit næste digitale projekt.
            </p>
