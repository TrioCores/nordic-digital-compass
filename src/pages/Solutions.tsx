...
import { ArrowRight, Globe, Smartphone, Search, Palette, Headphones, BarChart, CheckCircle } from "lucide-react";
...
const Solutions = () => {
  const solutions = [
    {
      ...
      description: "Professionelle og moderne hjemmesider bygget med de nyeste teknologier for optimal performance og brugeroplevelse.",
      features: [
    ...
    },
    {
      ...
      description: "Sikr dig at din hjemmeside fungerer perfekt på alle enheder med vores mobile-first tilgang.",
      features: [
    ...
    },
    {
      icon: Search,
      title: "SEO & Synlighed",
      description: "Bliv fundet på Google og andre søgemaskiner med vores omfattende SEO-strategi.",
      features: [
    ...
    },
    {
      ...
      description: "Unikt design der afspejler dit brand og dine værdier med nordisk æstetik og moderne trends.",
      features: [
    ...
    },
    {
      ...
      description: "Vi er her når du har brug for hjælp, ændringer eller har spørgsmål til din hjemmeside.",
      features: [
    ...
    },
    {
      ...
      description: "Følg din hjemmesides performance og få værdifuld indsigt i dine besøgendes adfærd.",
      features: [
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              ...
              Fra design til drift - vi håndterer det hele med nordisk kvalitet og gennemsigtighed.
            </p>
            <Button 
              size="lg" 
      ...
      {/* Solutions Grid */}
      <section id="solutions-grid" className="py-24 bg-gradient-to-b from-background via-secondary/20 to-background">
        <div className="container mx-auto px-6">
                ...
                <ul className="space-y-3">
                  {solution.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start gap-3">
                      <CheckCircle className="text-nordic-gold mt-0.5 flex-shrink-0" size={18} />
